...
def test_vscode_compat_suite() -> None:
    ...
    rt.set_provenance_file("tests/integration/test_otel_workflow_compat.py", 60)
    ...
    assert step.attributes["code.filepath"] == "tests/integration/test_otel_workflow_compat.py"
